...
func (x *ItemOrder) GetQuantity() int64 {
	if x != nil {
		return x.Quantity
	}
	return 0
...
func (x *Order) GetItems() []*ItemOrder {
	if x != nil {
		return x.Items
	}
	return nil
...
func (x *IndItem) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IndItem) ProtoMessage() {}

func (x *IndItem) ProtoReflect() protoreflect.Message {
	mi := &file_proto_order_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use IndItem.ProtoReflect.Descriptor instead.
func (*IndItem) Descriptor() ([]byte, []int) {
	return file_proto_order_proto_rawDescGZIP(), []int{2}
}

func (x *IndItem) GetItemId() string {
	if x != nil {
		return x.ItemId
	}
	return ""
...
func (x *IndItem) GetQuantity() int64 {
	if x != nil {
		return x.Quantity
	}
	return 0
...
func (x *IndItem) GetPrice() float32 {
	if x != nil {
		return x.Price
	}
	return 0
...
type Bill struct {
	...
	Items     []*IndItem `protobuf:"bytes,3,rep,name=items,proto3" json:"items,omitempty"`
...
func (x *Bill) GetTotalCost() float32 {
	if x != nil {
		return x.TotalCost
	}
	return 0
...
var file_proto_order_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0x3f, 0x0a, 0x09, 0x49, 0x74, 0x65, 0x6d, 0x4f, 0x72, 0x64, 0x65, 0x72,
	...
	0x74, 0x69, 0x74, 0x79, 0x22, 0x3b, 0x0a, 0x05, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x10, 0x0a,
	...
	0x2e, 0x49, 0x74, 0x65, 0x6d, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x05, 0x69, 0x74, 0x65, 0x6d,
	0x73, 0x22, 0x53, 0x0a, 0x07, 0x49, 0x6e, 0x64, 0x49, 0x74, 0x65, 0x6d, 0x12, 0x16, 0x0a, 0x06,
	...
	,
...
var file_proto_order_proto_goTypes = []interface{}{
	...
	(*Order)(nil),     // 1: Order
	(*IndItem)(nil),   // 2: IndItem
	(*Bill)(nil),      // 3: Bill
}
var file_proto_order_proto_depIdxs = []int32{
	0, // 0: Order.items:type_name -> ItemOrder
	2, // 1: Bill.items:type_name -> IndItem
	1, // 2: OrderService.PlaceOrder:input_type -> Order
	3, // 3: OrderService.PlaceOrder:output_type -> Bill
